...
- **Example**: `scripts/fix_imports.dart` for organizing imports across the project
- **Benefits**: Token efficient, deterministic

##### Examples (`examples/`)

Reference implementations loaded as needed into context.

- **When to include**: For documentation the agent should reference while working
- **Examples**: `examples/widget-button.md` for button widget, `examples/widget-card.md` for card widget
...
- **Examples**: `resources/logo.png` for brand assets, `resources/template.html` for HTML boilerplate
