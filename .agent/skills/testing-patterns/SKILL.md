...
### Dart/Flutter Syntax Mapping

| General Term | Dart/Flutter Equivalent |
|--------------|-------------------------|
...
| Type | Best For | Speed |
|------|----------|-------|
| **Unit** | BLoCs, Repositories, Logic | Fast (<50ms) |
| **Widget**| Individual Components, UI | Medium |
| **Integration**| Device flows, Permissions | Slow |
...
## 4.5. Widget Test Principles (Flutter)

### The 3 Phases
1. **Pump**: Build the widget (`await tester.pumpWidget(...)`)
2. **Find**: Locate elements (`find.text(...)`, `find.byType(...)`)
3. **Expect**: Verify state (`expect(finder, findsOneWidget)`)

### Common Finders & Matchers
- `find.text('Save')`
- `find.byType(CircularProgressIndicator)`
- `find.byKey(Key('submit_btn'))`
- `findsOneWidget`, `findsNothing`, `findsNWidgets(2)`

### Golden Tests (Visual Regression)
- Capture screenshot of widget state
...
### Recommended Frameworks (Dart)
- **Mockito**: Code generated mocks (strict types)
- **Mocktail**: Null-safe, no code generation (easier setup)
